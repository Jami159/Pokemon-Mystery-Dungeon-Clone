...
public class Entity{
	...
	public Entity(String name, String hp, String atk, String def, String exp, String level, String expType, String expYield, String type1, String type2, boolean enemy, int x, int y, String s){
	...
	public void update(){
		...
		if (actions[a].equals("atk") || actions[a].equals("specialatk")){
			...
			curImg = img[d][a][(frame/(60/len[a]))%len[a]];
		}
